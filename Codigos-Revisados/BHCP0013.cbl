      ...
      * DATA......: 01/07/2026
      * OBJETIVO..: LER PARTICIPANTES, VALIDAR E GERAR LOG DE REJEICOES
      * EXECUCAO..: COBOL - BATCH
      * ----------------------------------------------------------------
      * VRS DATA     RESPONSAVEL       DESCRICAO DA VERSAO
      * --- -------- ----------------- ---------------------------------
      * 001 01.07.26 MATHEUS KOLLMANN  IMPLANTACAO
      * ----------------------------------------------------------------
      ******************************************************************
      ...
      *----------------------------------------
       77  CTE-PROG                    PIC  X(008) VALUE 'BHCP0013'.
      ...
      *----------------------------------------------------------------*
       ...
       310099-FIM.
           EXIT.
      *----------------------------------------------------------------*
       400000-VALIDAR-PARTICIPANTE SECTION.
      *----------------------------------------------------------------*
      ...
      *----------------------------------------------------------------*
           DISPLAY ' '.
           DISPLAY 'PROGRAMA EXEC-13 ENCERRADO COM SUCESSO: ' CTE-PROG.
       920099-FIM.
           EXIT.

       END PROGRAM BHCP0013.
