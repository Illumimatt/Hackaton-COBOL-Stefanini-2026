      ...
      * DATA......: 01/07/2026
      * OBJETIVO..: PROGRAMA PRINCIPAL - PROCESSAMENTO COMPLETO
      * EXECUCAO..: COBOL - BATCH
      * ----------------------------------------------------------------
      * VRS DATA     RESPONSAVEL       DESCRICAO DA VERSAO
      * --- -------- ----------------- ---------------------------------
      * 001 01.07.26 MATHEUS KOLLMANN  ESTRUTURACAO ATE DATA DIVISION
      * ----------------------------------------------------------------
      ******************************************************************
      ...
      *----------------------------------------
       77  CTE-PROG                    PIC  X(008) VALUE 'BHCP0014'.
      ...
      *----------------------------------------------------------------*
       ...
       300099-FIM.
           EXIT.
      *----------------------------------------------------------------*
       310000-LER-PARTICIPANTE SECTION.
      *----------------------------------------------------------------*
           READ BHCF012S
               AT END
                   SET GDA-FIM-SIM TO TRUE
      ...
      *----------------------------------------------------------------*
       ...
       400099-FIM.
           EXIT.
      *----------------------------------------------------------------*
       410000-CHAMAR-SUBPROGRAMA SECTION.
      *----------------------------------------------------------------*
           CALL WS-SUBPROGRAMA USING GDA-AREA-COMUNICACAO.
       410099-FIM.
           EXIT.
      *----------------------------------------------------------------*
       500000-TRATAR-RETORNO SECTION.
      *----------------------------------------------------------------*
           IF GDA-COM-STATUS = 'V'
      ...
      *----------------------------------------------------------------*
           DISPLAY ' '.
           DISPLAY 'PROGRAMA EXEC-14 ENCERRADO COM SUCESSO: ' CTE-PROG.
       920099-FIM.
           EXIT.

       END PROGRAM BHCP0014.
