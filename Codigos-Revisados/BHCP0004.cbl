      ...
      *----------------------------------------
       01  GDA-CLIENTE.
           05  GDA-CLIENTE-CD          PIC X(004) VALUE SPACES.
           05  GDA-CLIENTE-NM          PIC X(020) VALUE SPACES.
           05  GDA-AGENCIA-NR          PIC 9(004) VALUE ZEROS.
           05  GDA-CONTA-NR            PIC 9(006) VALUE ZEROS.
           05  GDA-SALDO-VL            PIC 9(004) VALUE ZEROS.
      ******************************************************************
       PROCEDURE DIVISION.
      ******************************************************************
