      ...
      * DATA......: 01/07/2026
      * OBJETIVO..: GERAR ARQUIVO BATCH DE PARTICIPANTES (BASE)
      ...
      *----------------------------------------
       77  CTE-PROG                    PIC  X(008) VALUE 'BHCP0012'.
      ...
      *----------------------------------------------------------------*
       100000-INICIALIZAR.
      *----------------------------------------------------------------*
           MOVE ZEROS TO GDA-TOT-GRAVADOS GDA-TOT-ERROS
      ...
      *----------------------------------------------------------------*
           DISPLAY ' '.
           DISPLAY 'PROGRAMA EXEC-12 ENCERRADO COM SUCESSO: ' CTE-PROG.
       920099-FIM.
           EXIT.

       END PROGRAM BHCP0012.
