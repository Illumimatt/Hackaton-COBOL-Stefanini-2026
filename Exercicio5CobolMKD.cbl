      ...
      * --- -------- ----------------- ---------------------------------
      * 001 28.06.26 MATHEUS KOLLMANN  EXERCICIO 05
      * ----------------------------------------------------------------
      ******************************************************************
      ...
      *----------------------------------------
       ...
       01 GDA-CONTA.
            03 GDA-SALDO-INICIAL-VL    PIC 9(004) VALUE ZEROS.
            03 GDA-DEPOSITO-VL         PIC 9(004) VALUE ZEROS.
            03 GDA-SAQUE-VL            PIC 9(004) VALUE ZEROS.
            03 GDA-SALDO-FINAL-VL      PIC 9(004) VALUE ZEROS.
      ...
      *----------------------------------------------------------------*
            MOVE 1000                  TO GDA-SALDO-INICIAL-VL.
            MOVE 500                   TO GDA-DEPOSITO-VL.
            MOVE 200                   TO GDA-SAQUE-VL.
